...
import com.enableets.edu.sdk.ppr.cache.Exception.PPRLocaleCacheException;
...
public class LocalCache {
    ...
    public static void put(String key, Object data, Long liveTime) {
        ...
        if (dataMap.size() >= MAX_CACHE_SIZE){
            throw new PPRLocaleCacheException("The local cache has reached the maximum limit~");
        }
