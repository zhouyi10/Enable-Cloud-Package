	...
	([
		...
		(function(module, exports, __webpack_require__) {
				...
				_createClass(PhotoClip, [{
					...
					value: function _init() {
						...
						if ((0, _isNumber2.default)(options.size)) {
							...
							if (!(0, _isNumber2.default)(options.size[0]) || options.size[0] <= 0) options.size[0] = defaultOptions.size[
								0];
							if (!(0, _isNumber2.default)(options.size[1]) || options.size[1] <= 0) options.size[1] = defaultOptions.size[
								1];
						} else {
						...
						if ((0, _isNumber2.default)(options.outputSize)) {
							...
							if (!(0, _isNumber2.default)(options.outputSize[0]) || options.outputSize[0] < 0) options.outputSize[0] =
								defaultOptions.outputSize[0];
							if (!(0, _isNumber2.default)(options.outputSize[1]) || options.outputSize[1] < 0) options.outputSize[1] =
						...
						if ((0, _isArray2.default)(options.adaptive)) {
							this._widthIsPercent = options.adaptive[0] && (0, _isPercent2.default)(options.adaptive[0]) ? options.adaptive[
								0] : false;
							this._heightIsPercent = options.adaptive[1] && (0, _isPercent2.default)(options.adaptive[1]) ? options.adaptive[
								1] : false;
						}
						...
						(0, _bind2.default)(this, '_rotateCW90', '_fileOnChangeHandle', '_clipImg', '_resize', 'size', 'load',
							'clear', 'rotate', 'scale', 'clip', 'destroy');
					...
					value: function _refreshScroll(duration) {
						...
						if (width && height) {
							...
							iScrollOptions.startZoom = Math.min(iScrollOptions.zoomMax, utils.getScale(this._containerWidth, this._containerHeight,
								width, height));
						} else {
					...
					value: function _rotationLayerRotateReady(center) {
						...
						if (!center) {
							coord = utils.loaclToLoacl(this._$rotationLayer, this._$clipLayer, this._clipWidth * .5, this._clipHeight *
								.5);
						} else {
					...
					value: function _rotationLayerRotateFinish(angle, duration) {
						...
						if (angle !== this._curAngle && duration && (0, _isNumber2.default)(duration) && supportTransition !==
							undefined) {
							// 计算旋转层参考点，设为零位前后的偏移量
							offset = {
							...
							setOrigin(this._$rotationLayer, this._rotationLayerOriginX, this._rotationLayerOriginY);
							setTransform(this._$rotationLayer, this._rotationLayerX + offset.x, this._rotationLayerY + offset.y,
								this._curAngle);

							// 开始旋转
							this._atRotation = true;
							setTransition(this._$rotationLayer, this._rotationLayerX + offset.x, this._rotationLayerY + offset.y,
								angle, duration,
								function() {
					...
					value: function _rotateFinishUpdataElem(angle) {
						...
						setTransform(this._$rotationLayer, this._rotationLayerX, this._rotationLayerY, this._curAngle = angle %
							360);
					}
				}, {
					key: '_initFile',
					...
					value: function _lrzHandle(src) {
						...
						if ((typeof src === 'undefined' ? 'undefined' : _typeof(src)) === 'object' && src.type && !/image\/\w+/.test(
								src.type)) {
			...
			function setTransform($obj, x, y, angle) {
				...
				(0, _css2.default)($obj, prefix + 'transform', 'translateZ(0) translate(' + x + 'px,' + y + 'px) rotate(' +
					angle + 'deg)');
			}
			...
			function setTransition($obj, x, y, angle, dur, fn) {
				...
				(0, _css2.default)($obj, prefix + 'transition', prefix + 'transform ' + dur +
