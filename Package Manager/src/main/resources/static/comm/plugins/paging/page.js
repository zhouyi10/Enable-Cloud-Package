...
var  page = {
    ...
    "initPageEvent":function(pageId,listCount,fun){
        $("#"+pageId +">li[class='pageItem']").on("click",function(){
        	$("input[name='pageCondition\\.pageNo']").val($(this).attr("page-data"));
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        var appendStr ="";
          appendStr+="<li class='"+prePageClass+"' page-data='1' page-rel='firstpage'>"+$lang['first_page']+"</li>";
        appendStr+="<li class='"+prePageClass+"' page-data='"+prePage+"' page-rel='prepage'>"+$lang['prev_page']+"</li>";
        ...
        appendStr+="<li class='"+nextPageClass+"' page-data='"+nextPage+"' page-rel='nextpage'>"+$lang['next_page']+"</li>";
          appendStr+="<li class='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'>"+$lang['last_page']+"</li>";
       return appendStr;
