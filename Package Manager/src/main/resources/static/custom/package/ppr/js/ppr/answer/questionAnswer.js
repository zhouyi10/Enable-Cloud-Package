(function($,window) {
	...
	var AnswerQuestion = window.AnswerQuestion = {
			...
			initEvent : function() {
                ...
                var axisHtmlTem = '<div class="ques_item_related" style="left: {0}px; top: {1}px; width: {2}px; height: {3}px;"></div>';
                var axisHtmlTem_ = '<div class="ques_item_not_related" style="left: {0}px; top: {1}px; width: {2}px; height: {3}px;"></div>';
