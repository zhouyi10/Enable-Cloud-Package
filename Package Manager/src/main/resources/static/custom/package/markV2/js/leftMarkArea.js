(function(){
    ...
    var LeftMarkArea = window.LeftMarkArea = {
        ...
        initHtml : function(userAnswer) { //初始化
            ...
            var userAnswerStr = _this.curUserAnswer.userAnswer == null ? "":_this.curUserAnswer.userAnswer;
            $('.left').find('#userAnswer').empty().append('<div class="userAnswer">'+userAnswerStr+'</div>');
            if(CommUtils.isEmpty(_this.curUserAnswer.canvases)) {
                $(_this.canvasRootSelector).hide();
            }
    ...
    var input = LeftMarkArea.input = {
        ...
        endDraw : function(ctx, position) {
            ...
            _this.$input.css({
                ...
                'top' : position.clientY - containterRect.top + 65,
