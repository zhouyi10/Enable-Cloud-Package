...
@ApiModel(value = "EditPPRInfoVO", description = "Edit PPR")
public class EditPPRInfoVO extends BaseVO {

    @Override
    public void validate() throws MicroServiceException {
        notNull(contentId, "contentId");
        notNull(user, "user");
        notNull(answerCard, "answerCard");
    }
    ...
    private EditAnswerCardInfoVO answerCard;
}
